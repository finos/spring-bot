...
import com.symphony.spring.api.health.AgentHealthHelper;
import com.symphony.spring.api.properties.EndpointProperties;
import com.symphony.spring.api.properties.PodProperties;
import com.symphony.spring.api.properties.PodProperties.AuthMethod;
		...
		if (usingCertificates(id, pp)) {
			...
			tm = new TokenManager(
					() -> login.getApi(com.symphony.api.login.AuthenticationApi.class)
							.pubkeyAppAuthenticatePost(createAuthenticateRequest(id)),
