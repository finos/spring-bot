...
1.  Head to `https://localhost/symphony-app/bundle.json`.  This page should load.  You might need to specify a port number.  If the certificate comes up untrusted, add it.
