...
public class SymphonyRoomSharedLog extends LogMessageHandlerImpl implements SharedLog  {
	...
	public SymphonyRoomSharedLog(String clusterName, String streamId, MessagesApi messagesApi, String environmentSuffix, long participationIntervalMillis, EntityJsonConverter ejc) {
		super(clusterName, streamId, messagesApi, environmentSuffix, ejc);
