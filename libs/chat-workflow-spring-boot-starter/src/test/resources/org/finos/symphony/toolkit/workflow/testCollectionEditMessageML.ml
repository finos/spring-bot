...
<form
 ...
 <tr><td><b>Names:</b></td><td>
  ...
  <tr><td>${iB!''}</td>
   <td style="text-align:center;" ><checkbox name="names.${iB?index}.selected" /></td>
 ...
 <tr><td><b>Addresses:</b></td><td>
  ...
  <tr>
   ...
   <td >${iB.city!''}</td>
   <td style="text-align:center;" ><checkbox name="addresses.${iB?index}.selected" /></td>
