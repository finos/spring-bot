...
public class SymphonyHistoryImpl extends AbstractStreamResolving implements SymphonyHistory {
	...
	public SymphonyHistoryImpl(EntityJsonConverter jsonConverter, MessagesApi messageApi, StreamsApi streamsApi,
			UsersApi usersApi, SymphonyApiProperties symphonyApiProperties) {
