...
public class SymphonyPayload {
    ...
    public SymphonyPayload(String project, String build, String branch, String statusText, String statusColor, String btId, long buildId, String serverUrl) {
